...
public class SIMViewException extends CardRuntimeException {
    ...
    /** This reason code (= 12) is used to indicate that the requested pattern is
     *  greater than than the record size.
     */
    public static final short PATTERN_SIZE_INCONSISTENT          = (short)12;

    /** This reason code (= 13) is used to indicate that method can not be performed as
     *  maximum value of the record is reached.
     */
    public static final short MAX_VALUE_REACHED                  = (short)13;

    /** This reason code (= 14) is used to indicate that a memory problem occured.
     */
    public static final short MEMORY_PROBLEM                     = (short)14;
