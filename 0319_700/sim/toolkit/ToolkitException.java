...
public class ToolkitException extends CardRuntimeException {
     ...
     */
    public static final short ENTRY_NOT_FOUND           = (short)4;
    ...
    /** This reason code (= 7) is used to indicate that the event is already
     *  registered by number of possible applets (e.g Call Control)*/
     ...
     */
    public static final short OUT_OF_ITEM_BOUNDARIES  	= (short)10;
    ...
    /** This reason code (=14) is used to indicate that the indicated Status Type
     *  is not supported by the SIM Toolkit Framework
     */
    public static final short INVALID_STATUS_TYPE 		= (short)14;
