...
public final class MEProfile {
     ...
     *      <li>BAD_INPUT_PARAMETER if index has a negative valuey</ul>
     */
     ...
     *
     * @return true if the bitwise AND of the MEProfile data padded with 0 and the <code>mask</mask> is equal to the 
     ...
     * The values outside the MEProfile data available are considered to be set to 0.
     *
     * <p>
     * Notes:<ul>
