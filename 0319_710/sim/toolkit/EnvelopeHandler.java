...
public final class EnvelopeHandler extends ViewHandler {
     ...
     * Simple TLV contained in the Envelope handler. This can be used on an event
     ...
     * If the element is available it becomes the TLV selected.
	 *
     * @return the offset of the Secured Data first byte in the first SMS TPDU TLV element
     *
     * @exception ToolkitException with the following reason codes: <ul>
     ...
     * If the element is available it becomes the TLV selected.
	 *
     * @return the length of the Secured Data contained in the first SMS TPDU TLV element (without padding bytes)
     *
     * @exception ToolkitException with the following reason codes: <ul>
     *      <li><code>UNAVAILABLE_ELEMENT</code> in case of unavailable SMS TPDU TLV element or missing Secured Data </ul>
     */
